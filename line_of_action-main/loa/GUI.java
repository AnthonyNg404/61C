...
class GUI extends TopLevel implements View, Reporter {
    ...
    GUI(String title) {
        ...
        addMenuButton("Game->Help", (s) -> displayText("Loa Help", HELP_TEXT));
        addMenuButton("Game->Undo", this::undo);
        addMenuButton("Game->Auto White", this ::autoWhite);
        addMenuButton("Game->Auto black", this ::autoBlack);
        addMenuButton("Game->Manual black", this ::manualBlack);
        addMenuButton("Game->Manual white", this ::manualWhite);
    ...
    /** switch the black player to manual. */
    ...
    /** switch the white player to manual. */
    ...
    /** switch the black player to auto. */
