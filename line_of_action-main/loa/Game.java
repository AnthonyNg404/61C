...
class Game {
    ...
    private void processCommand(String line) {
        ...
        if (command.matches()) {
            ...
            case "dump":
                ...
                break;
            case "manual":
                manualCommand(command.group(2).toLowerCase()); break;
            case "auto":
                autoCommand(command.group(2).toLowerCase()); break;
            case "quit":
                quit(); break;
            case "undo":
                undo(); break;
            ...
            case "auto black":
                autoBlack(); break;
            case "manual black":
                switchBlackToManual(); break;
            case "manual white":
                switchWhiteToManual(); break;
            case "seed":
    ...
    /** switch Black To Manual. */
    void switchBlackToManual() {
        if (!manualBlack()) {
            manualCommand("black");
    ...
    /** switch white to manual. */
    void switchWhiteToManual() {
        if (!manualWhite()) {
            manualCommand("white");
        }
